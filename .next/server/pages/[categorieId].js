...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_Navbar__WEBPACK_IMPORTED_MODULE_4__, _firebase_firebase__WEBPACK_IMPORTED_MODULE_6__, firebase_firestore__WEBPACK_IMPORTED_MODULE_7__]);
([_components_Navbar__WEBPACK_IMPORTED_MODULE_4__, _firebase_firebase__WEBPACK_IMPORTED_MODULE_6__, firebase_firestore__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const getStaticProps = async (context)=>{
    ...
    const collectionRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_7__.query)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_7__.collectionGroup)(db, "examenes"), (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_7__.where)("categoria", "==", categorieName), (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_7__.limit)(5));
    //se genera un snapshor con todos los documentos
    const snapshot = await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_7__.getDocs)(collectionRef);
    //se mapea cada documento para hacer push de
    //sus datos en el array categorias
...
var __webpack_exports__ = __webpack_require__.X(0, [952,664,684,631,124], () => (__webpack_exec__(7629)));
